...
replaceAllButton.addEventListener("click", function () {
  ...
  for (let i = 0; i < rowElements.length; i = i + 1) {
    ...
    for (let j = 0; j < cellElements.length; j = j + 1) {
      let cellBox = cellElements[j].innerHTML;
      console.log(cellBox);
...
// YOUR CODE GOES HERE// One last thing: dedicate very careful attention to using variables and
